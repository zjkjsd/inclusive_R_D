...
dz1_tuning = 36 #[64, 100, 225] # 225, 400, 625
dr2_tuning = [25, 36, 49] # 36, 64, 100
...
x=0
small_dfs = []
for dr2 in dr2_tuning:
    for dz2 in dz2_tuning:
...
large_df.to_csv(f'/home/belle/zhangboy/R_D/Signal_MC_ROEx1/B2{decaymode}_nu/Ntuples/MaskTuning_Track_drdz2_2.csv')
