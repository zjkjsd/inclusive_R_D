...
ma.applyCuts(f"mu-:mymu", "muonID_noSVD>0.9", path=main_path)
...
b_vars = vu.create_aliases_for_selected(
    ...
    + extra_mcDaughters_vars + cms_kinematics + vc.kinematics
    #+ vc.flight_info + vc.mc_flight_info + roel_DOCA_Chi2 + cms_kinematics + vc.kinematics + vc.inv_mass
    + ['vtxDDSig','roel_DistanceSig_dis','mcErrors','mcPDG','genParticleID','charge'],#'DecayHash','DecayHashEx',
