...
filesize = sys.argv[2]
input_file = f'./B2{decaymode}_nu/MC/MC_mu_{filesize}.root'
output_file = f'./B2{decaymode}_nu/Ntuples/MC_mu_{filesize}.root'
output_hash = f'./B2{decaymode}_nu/Ntuples/hashmap_MC_mu_{filesize}.root'
