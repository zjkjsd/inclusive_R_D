...
# bsub -q l 'basf2 /current/directory/3_Reconstruction_e.py  D_tau/Dst_l 50k/10k'
import sys
decaymode = sys.argv[1]
filesize = sys.argv[2]
input_file = f'/home/belle/zhangboy/R_D/Samples/Signal_MC_ROEx1/B2{decaymode}_nu/MC/MC_e_{filesize}.root'
output_file = f'/home/belle/zhangboy/R_D/Samples/Signal_MC_ROEx1/B2{decaymode}_nu/Ntuples/bengal_e_{filesize}_2.root'
output_hash = f'/home/belle/zhangboy/R_D/Samples/Signal_MC_ROEx1/B2{decaymode}_nu/Ntuples/hashmap_bengal_e_{filesize}_2.root'
...
#Dcuts = '1.855 < M < 1.885'
Dcuts = '1.84 <M< 1.9'
Dcuts_sideband = '1.84>M or M>1.9'
...
vx.treeFit('anti-B0:De', conf_level=0.00, updateAllDaughters=False, massConstraint=[], ipConstraint=True, path=main_path)
...
ma.variablesToNtuple('anti-B0:De', candidate_vars, basketsize=100000,
