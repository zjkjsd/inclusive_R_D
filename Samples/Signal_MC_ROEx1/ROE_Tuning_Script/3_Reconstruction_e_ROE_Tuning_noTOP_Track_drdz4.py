...
dr3 = 36  #[25, 36, 64]
dz3 = 100 #[64, 100, 144]
dr4_tuning = [36, 49] # 4, 9, 16
dz4_tuning = [49, 64] # 9, 16, 25
...
x=0
small_dfs = []
for dr4 in dr4_tuning:
    for dz4 in dz4_tuning:
...
large_df.to_csv(f'/home/belle/zhangboy/R_D/Signal_MC_ROEx1/B2{decaymode}_nu/Ntuples/MaskTuning_Track_drdz4_2.csv')
