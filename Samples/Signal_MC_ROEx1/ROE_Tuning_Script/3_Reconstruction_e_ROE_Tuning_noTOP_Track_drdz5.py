...
x=0
small_dfs = []
for dr5 in dr5_tuning:
    for dz5 in dz5_tuning:
...
large_df.to_csv(f'/home/belle/zhangboy/R_D/Signal_MC_ROEx1/B2{decaymode}_nu/Ntuples/MaskTuning_Track_drdz5_2.csv')
