...
for name, sample in samples.items():
    ...
    print(colored(f'Writing Template for {name}', 'magenta'))
    print(colored(f'NOE in the Template is {np.sum(counts)}', 'blue'))
    
    counts = counts.T + 0.00001
